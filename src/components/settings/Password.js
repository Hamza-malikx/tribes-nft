...
const Password = () => {
  return (
    <>
      <div class="view_order_tab_content_box" id="view_order_tab_content">
        ...
        <div class="view_order_tab_content">
          <div class="password_tab_content_main">
            <div class="password_tab_content_part_one">
              ...
              <p>
                Tribal III Gaming keeps your information including passwords
                well guarded in our system.
              </p>
            ...
            <div class="password_tab_content_part_three">
              ...
              <form>
                <div class="password_tab_content_input_field_main">
                  ...
                  <div class="password_tab_content_input_field">
                    <span>
                      First email associated with your account. If you can’t
                      remember, give us the earliest email you can!
                    </span>
                    <input placeholder="" />
                  </div>
                  <div class="password_tab_content_input_field">
                    <span>
                      Phone number associated with your account. You may have
                      provided this earlier to help in times like these!
                    </span>
                    <input placeholder="" />
                  </div>
                </div>
