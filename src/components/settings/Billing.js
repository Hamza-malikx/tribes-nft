...
const Billing = () => {
  return (
    <>
      <div class="personal_info_tab_content_box" id="billing_tab_content">
        ...
        <div class="billing_detail_section">
          <p>
            Your purchases and subscriptions will be billed to the payment
            methods below
          </p>
          ...
          <div class="billing_detail_section_box">
            ...
            <div class="billing_detail_section_box_main">
              <div class="billing_detail_section_box_card_detail">
                <div class="billing_detail_section_box_data">
                  <span>Card #</span>
                  <small>**** 4198</small>
                </div>
                <div class="billing_detail_section_box_data">
            ...
            <div class="billing_edit_payment_method">
